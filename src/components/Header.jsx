  ...
  return (
    <header className="sticky top-0 z-20 shadow h-25 backdrop-blur-5 bg-white">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8 justify-center font-bold font-poppins" ref={menuRef}>
          ...
          <div className="relative group" onClick={handleDropdownClick}>
            <button
              onClick={() => {
                setIsInvolvedOpen(!isInvolvedOpen);
                setIsProgramsOpen(false);
              }}
              className="flex items-center text-gray-600 hover:text-red-600 transition-colors duration-300"
            >
      ...
      <nav className={`md:hidden flex flex-col space-y-2 mt-2 items-center transition-all duration-300 ease-in-out transform ${isOpen ? 'opacity-100 max-h-screen pb-4' : 'opacity-0 max-h-0 overflow-hidden'}`}>
        ...
        <div>
          ...
          {isProgramsOpen && (
            <div className="flex flex-col mt-2 space-y-2" onClick={handleDropdownClick}>
              ...
              <Link to="/program" className="text-gray-600 font-bold hover:text-red-600 transition-colors duration-300" onClick={handleDropdownItemClick}>Rural Dev..</Link>
            </div>
          )}
        </div>
        ...
        <div>
          ...
          {isInvolvedOpen && (
            <div className="flex flex-col mt-2 space-y-2" onClick={handleDropdownClick}>
              ...
              <Link to="/partner" className="text-gray-600 font-bold hover:text-red-600 transition-colors duration-300" onClick={() => { handleDropdownItemClick(); scrollToPartnerForm(); }}>Partner</Link>
              ...
              <Link to="/careers" className="text-gray-600 font-bold hover:text-red-600 transition-colors duration-300" onClick={handleDropdownItemClick}>Internship</Link>
            </div>
          )}
        </div>
